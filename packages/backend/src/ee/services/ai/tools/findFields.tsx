...
const renderField = (catalogField: CatalogField) => {
    ...
    return (
        <field
            ...
            searchRank={catalogField.searchRank ?? 0}
            chartUsage={catalogField.chartUsage ?? 0}
        >
...
const getFieldsText = (
    ...
    <searchresult
        ...
        totalPageCount={args.pagination?.totalPageCount ?? 0}
        totalResults={args.pagination?.totalResults ?? 0}
    >
