...
import bratraxMcpRouter from '../bratrax/mcp/bratraxMcpRouter';
import oauthRouter from './oauthRouter';
import { bratraxRouter } from './bratraxRouter';
...
apiV1Router.use('/mcp', bratraxMcpRouter);
apiV1Router.use('/oauth', oauthRouter);
apiV1Router.use('/bratrax', bratraxRouter);
