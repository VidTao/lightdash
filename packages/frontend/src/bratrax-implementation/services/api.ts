...
export class ApiService {
  ...
  getfbAdAccounts = (accessToken: string): Promise<any> => {
    return new Promise((resolve, reject) => {
      // @ts-ignore
      window.FB?.api("/me/adaccounts", { access_token: accessToken, fields: "account_id,name" }, (response: any) => {
        if (response && !response.error) {
          resolve(response);
        } else {
  ...
  getPinterestAuthUrl = async (): Promise<string> => {
    try {
      const response = await axios.get(`${apiUrl}/connectors/pinterest/auth-url`);
  ...
  generatePinterestTokensDataAndSaveinBQ = async (code: string): Promise<string> => {
    try {
      const response = await axios.post(`${apiUrl}/connectors/pinterest/insertTokensData`, { code: code });
  ...
  getShopifyAuthUrl = async (): Promise<string> => {
    try {
      const response = await axios.get(`${apiUrl}/connectors/shopify/auth-url`);
      return response.data.url; // Return the URL from the response
    } catch (error) {
  ...
  getShopifyShopAuthUrl = async (shop: string): Promise<string> => {
    try {
      const response = await axios.get(`${apiUrl}/connectors/shopify/shop-auth-url`, {
        params: {
          shop: shop,
        },
      });
  ...
  generateShopifyTokensDataAndSaveinBQ = async (code: string, shop: string): Promise<string> => {
    try {
      const response = await axios.post(`${apiUrl}/connectors/shopify/insertTokensData`, { code: code, shop: shop });
      return response.data;
    } catch (error) {
      console.error("Error getting Pinterest tokens data:", error);
      throw error;
  ...
  getGoHighLevelAuthUrl = async (): Promise<string> => {
    try {
      const response = await axios.get(`${apiUrl}/connectors/gohighlevel/auth-url`);
      return response.data.url; // Return the URL from the response
    } catch (error) {
      console.error("Error getting Shopify auth URL:", error);
      throw error;
  ...
  generateGoHighLevelTokensDataAndSaveinBQ = async (code: string): Promise<string> => {
    try {
      const response = await axios.post(`${apiUrl}/connectors/gohighlevel/insertTokensData`, { code: code });
      return response.data;
    } catch (error) {
      console.error("Error getting Pinterest tokens data:", error);
      throw error;
  ...
  generateFBTokensDataAndSaveinBQ = async (
    ...
    const response = await axios.post(`${apiUrl}/connectors/facebook/insertTokensData`, {
  ...
  getAllGoogleManagerAccounts = async (code: any) => {
    try {
      const response = await axios.get(`${apiUrl}/connectors/google/adAccounts`, {
        params: {
          code: code,
        },
        headers: {
  ...
  generateGoogleTokensDataAndSaveinBQ = async (code: string, selectedAccounts: AdPlatformAccountInfo[]) => {
    const response = await axios.post(`${apiUrl}/connectors/google/insertTokensData`, {
      code: code,
      selectedAccounts: selectedAccounts,
    });
    return response.data;
  ...
  getClickFunnel2AuthUrl = async (): Promise<string> => {
    try {
      const response = await axios.get(`${apiUrl}/connectors/clickfunnels2/auth-url`);
      return response.data.url; // Return the URL from the response
    } catch (error) {
  ...
  generateClickFunnel2TokensDataAndSaveinBQ = async (code: string) => {
    const response = await axios.post(`${apiUrl}/connectors/clickfunnels2/insertTokensData`, {
      code: code,
    });
    return response.data;
  };
  ...
  getKlaviyoAuthUrl = async (): Promise<string> => {
    try {
      const response = await axios.get(`${apiUrl}/connectors/klaviyo/auth-url`);
      return response.data.url; // Return the URL from the response
    } catch (error) {
  ...
  generateKlaviyoTokensDataAndSaveinBQ = async (code: string, state: string): Promise<string> => {
    try {
      const response = await axios.post(`${apiUrl}/connectors/klaviyo/insertTokensData`, { code: code, state: state });
      return response.data;
    } catch (error) {
      console.error("Error getting Pinterest tokens data:", error);
      throw error;
  ...
  registerApplicationUser = async (userId: string, email: string, name: string) => {
  ...
  getPlatformConnection = async (platformType: string) => {
    const response = await axios.get(`${apiUrl}/users/get-platform-connection`, {
  ...
  getCRMConnections = async (platformType: string) => {
    const response = await axios.get(`${apiUrl}/users/get-crm-connections`, {
      params: { platform_type: platformType },
    });
    return response.data;
  };
  ...
  getStripeAuthUrl = async (): Promise<string> => {
    try {
      const response = await axios.get(`${apiUrl}/connectors/stripe/auth-url`);
      return response.data.url; // Return the URL from the response
    } catch (error) {
      console.error("Error getting Shopify auth URL:", error);
      throw error;
  ...
  generateStripeTokensDataAndSaveinBQ = async (code: string): Promise<string> => {
    try {
      const response = await axios.post(`${apiUrl}/connectors/stripe/insertTokensData`, { code: code });
      return response.data;
    } catch (error) {
  ...
  getStandardEvents = async (platform: string): Promise<any> => {
    try {
      const response = await axios.get(`${apiUrl}/tracking-plan/standard-events`, {
        params: {
          platform,
        },
      });
  ...
  getProperties = async (): Promise<any> => {
    try {
      const response = await axios.get(`${apiUrl}/tracking-plan/properties`);
      return response.data;
    } catch (error) {
  ...
  insertCustomEvent = async (event: any) => {
    try {
      const response = await axios.post(`${apiUrl}/tracking-plan/insert-custom-event`, event);
      return response.data;
    } catch (error) {
  ...
  getGoogleAdsMetrics = async (accessToken: string, customerId: string, managerId?: string) => {
    try {
      const response = await axios.get(`${apiUrl}/connectors/google/metrics`, {
        params: {
  ...
  getGoogleAdsPerformance = async (
    ...
    try {
      const response = await axios.get(`${apiUrl}/connectors/google/performance`, {
        params: {
          access_token: accessToken,
          customer_id: customerId,
  ...
  verifyDomain = async (domain: string, expectedValue: string): Promise<any> => {
    try {
  ...
  getFacebookAdsMetrics = async (accessToken: string): Promise<any> => {
    try {
      const response = await axios.get(`${apiUrl}/connectors/facebook/metrics`, {
        params: {
          access_token: accessToken,
        },
      });
  ...
  getFacebookAdsPerformance = async (
    ...
    try {
      const response = await axios.get(`${apiUrl}/connectors/facebook/performance`, {
        params: {
          access_token: accessToken,
          date_range: dateRange,
        },
  ...
  getShopifyMetrics = async (): Promise<any> => {
    try {
      const response = await axios.get(`${apiUrl}/connectors/shopify/metrics`);
      return response.data;
    } catch (error) {
  ...
  getShopifyPerformance = async (dateRange: "LAST_30_DAYS" | "LAST_7_DAYS" = "LAST_7_DAYS") => {
    try {
      const response = await axios.get(`${apiUrl}/connectors/shopify/performance`, {
        params: {
          date_range: dateRange,
        },
      });
  ...
  getShopifyProducts = async (): Promise<any> => {
    try {
      const response = await axios.get(`${apiUrl}/connectors/shopify/products`);
      return response.data;
    } catch (error) {
  ...
  getAmazonAuthUrl = async (region: string): Promise<string> => {
    try {
      const response = await axios.get(`${apiUrl}/connectors/amazon/auth-url`, {
        params: {
          region: region,
        },
      });
  ...
  generateAmazonTokensDataAndSaveinBQ = async (
    ...
    try {
      const response = await axios.post(`${apiUrl}/connectors/amazon/insertTokensData`, {
        code,
        region,
  ...
  getAmazonAdsAuthUrl = async (region: string): Promise<string> => {
    try {
      const response = await axios.get(`${apiUrl}/connectors/amazon-ads/auth-url`, {
        params: {
          region: region,
        },
      });
  ...
  generateAmazonAdsTokensDataAndSaveinBQ = async (code: string, state: string, region: string): Promise<string> => {
    try {
      const response = await axios.post(`${apiUrl}/connectors/amazon-ads/insertTokensData`, {
        code: code,
        state: state,
        region: region,
      });
  ...
  getStoreCogsSettings = async (platformType: string): Promise<any> => {
    try {
      const response = await axios.get(`${apiUrl}/cost-settings/store-cogs`, {
        params: {
  ...
  getProductsWithCogsSettings = async (platformType: string, marketplace: string): Promise<any> => {
    try {
      const response = await axios.get(`${apiUrl}/cost-settings/products-with-cogs`, {
        params: {
          platform_type: platformType,
  ...
  insertShippingProfile = async (shippingProfile: ShippingProfile): Promise<any> => {
    try {
      const response = await axios.post(`${apiUrl}/cost-settings/insert-shipping-profile`, {
  ...
  getShippingProfiles = async (): Promise<any> => {
    try {
      const response = await axios.get(`${apiUrl}/cost-settings/shipping-profiles`);
  ...
  insertPaymentGatewaySettings = async (settings: PaymentGatewaySettings): Promise<any> => {
    try {
      console.log("Settings:", settings);
      const response = await axios.post(`${apiUrl}/cost-settings/insert-payment-gateway`, {
  ...
  getPaymentGateways = async (): Promise<any> => {
    try {
      const response = await axios.get(`${apiUrl}/cost-settings/payment-gateways`, {});
  ...
  updatePaymentGatewaySettings = async (record: PaymentGatewaySettings): Promise<any> => {
    try {
      const response = await axios.put(`${apiUrl}/cost-settings/update-payment-gateway/${record.gatewayId}`, {
  ...
  getPeriscopeAdvertisingConnections = async (platformType: string) => {
    try {
      const response = await axios.get(`${apiUrl}/periscope/advertising-connections`, {
        params: {
          platform_type: platformType,
        },
      });
      ...
      console.error("Error fetching periscope advertising connections:", error);
      throw error;
    }
  };
  ...
  updatePeriscopeEvents = async (accountId: string, eventIds: string[]): Promise<any> => {
    try {
  ...
  updateStoreCogsSettings = async (platformType: string, cogsSettings: COGSSettings): Promise<any> => {
    try {
      const response = await axios.put(`${apiUrl}/cost-settings/store-cogs`, cogsSettings, {
        params: {
          platform_type: platformType,
        },
      });
  ...
  updateProductCogsSettings = async (platformType: string, productCogsSettings: any[]): Promise<any> => {
    try {
      const response = await axios.put(
  ...
  updateShippingProfile = async (shippingProfile: ShippingProfile): Promise<any> => {
    try {
      const response = await axios.put(`${apiUrl}/cost-settings/update-shipping-profile/${shippingProfile.profileId}`, {
        profile_name: shippingProfile.profileName,
        is_worldwide: shippingProfile.isWorldwide,
        regions: shippingProfile.regions,
        rate_type: shippingProfile.rateType,
  ...
  generateAndInsertOutbrainToken = async (encodedAuth: string): Promise<string> => {
    try {
      const response = await axios.post(`${apiUrl}/connectors/outbrain/auth-url`, {
        auth: encodedAuth,
      });
      return response.data.url; // Return the URL from the response
    } catch (error) {
  ...
  getTaboolaAuthUrl = async (): Promise<string> => {
    try {
      const response = await axios.get(`${apiUrl}/connectors/taboola/auth-url`);
      return response.data.url; // Return the URL from the response
    } catch (error) {
      console.error("Error getting Pinterest auth URL:", error);
      throw error;
