...
CREATE TABLE bratrax_write_keys (
    ...
    CONSTRAINT fk_bwk_organization
        ...
        REFERENCES public.organizations(organization_uuid) 
        ON DELETE CASCADE,
...
CREATE INDEX idx_bwk_organization_uuid ON bratrax_write_keys(organization_uuid);
...
CREATE TABLE bratrax_user_platform_credentials (
    ...
    CONSTRAINT fk_bupc_bratrax_write_key
        ...
        ON DELETE SET NULL,
    CONSTRAINT fk_bupc_created_by_user
...
CREATE INDEX idx_bupc_organization_platform ON bratrax_user_platform_credentials(organization_uuid, platform);
...
CREATE INDEX idx_bac_organization_platform ON bratrax_advertising_connections(organization_uuid, platform_type);
...
CREATE TABLE bratrax_expense_categories (
    ...
    CONSTRAINT fk_bec_created_by_user
        ...
        REFERENCES public.users(user_uuid)
        ON DELETE SET NULL,
    UNIQUE (organization_uuid, category_name)
);
...
CREATE INDEX idx_bfe_organization_write_key ON bratrax_fixed_expenses(organization_uuid, bratrax_write_key_id);
...
CREATE INDEX idx_bpgs_organization_write_key ON bratrax_payment_gateway_settings(organization_uuid, bratrax_write_key_id);
...
CREATE INDEX idx_bpcs_organization_write_key ON bratrax_product_cogs_settings(organization_uuid, bratrax_write_key_id);
...
CREATE INDEX idx_bprod_organization_write_key ON bratrax_products(organization_uuid, bratrax_write_key_id);
...
CREATE INDEX idx_bsp_organization_write_key ON bratrax_shipping_profiles(organization_uuid, bratrax_write_key_id);
...
CREATE INDEX idx_bscs_organization_write_key ON bratrax_store_cogs_settings(organization_uuid, bratrax_write_key_id);
...
CREATE TABLE bratrax_traffic_rules (
    ...
    CONSTRAINT fk_btr_updated_by_user
        ...
        REFERENCES public.users(user_uuid)
        ON DELETE SET NULL,
    UNIQUE(organization_uuid, bratrax_write_key_id, rule_name) 
);
CREATE INDEX idx_btr_organization_write_key ON bratrax_traffic_rules(organization_uuid, bratrax_write_key_id);
...
CREATE INDEX idx_bve_organization_write_key ON bratrax_variable_expenses(organization_uuid, bratrax_write_key_id);
...
CREATE INDEX idx_bdfr_organization_write_key ON bratrax_default_traffic_rules(organization_uuid, bratrax_write_key_id);
...
CREATE INDEX idx_be_organization_write_key ON bratrax_events(organization_uuid, bratrax_write_key_id);
...
CREATE INDEX idx_bprop_organization_write_key ON bratrax_properties(organization_uuid, bratrax_write_key_id);
...
CREATE INDEX idx_bep_organization_write_key ON bratrax_event_properties(organization_uuid, bratrax_write_key_id);
...
CREATE TABLE bratrax_periscope_events (
    ...
    CONSTRAINT fk_bpse_event
        ...
        REFERENCES bratrax_events(bratrax_event_id) 
        ON DELETE CASCADE,
    UNIQUE (organization_uuid, account_id, bratrax_event_id, bratrax_advertising_connection_id)
);
CREATE INDEX idx_bpse_org_account_event ON bratrax_periscope_events(organization_uuid, account_id, bratrax_event_id);
...
CREATE INDEX idx_bcc_organization_write_key ON bratrax_crm_connections(organization_uuid, bratrax_write_key_id);
